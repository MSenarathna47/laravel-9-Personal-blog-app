    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ asset('backend/') }}javascript: void(0);" class="has-arrow waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ asset('backend/') }}javascript: void(0);" class="has-arrow">Vertical</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ asset('backend/') }}layouts-dark-sidebar.html">Dark Sidebar</a></li>
                                <li><a href="{{ asset('backend/') }}layouts-compact-sidebar.html">Compact Sidebar</a></li>
                        ...
                        <li>
                            <a href="{{ asset('backend/') }}javascript: void(0);" class="has-arrow">Horizontal</a>
                            <ul class="sub-menu" aria-expanded="true">
